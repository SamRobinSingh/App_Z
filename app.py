...
# Set custom web page title (must be at the top of the script)
...
# Load the tokenizer
try:
    with open('/content/tokenizer.pkl', 'rb') as tokenizer_file:
        tokenizer = pickle.load(tokenizer_file)
except FileNotFoundError:
    st.error("Tokenizer file not found.")
    st.stop()
except ImportError:
    st.error("Error loading tokenizer: No module named 'keras.preprocessing.text'")
    st.stop()
